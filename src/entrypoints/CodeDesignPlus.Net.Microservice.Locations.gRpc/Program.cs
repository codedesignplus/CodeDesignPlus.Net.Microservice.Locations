...
using CodeDesignPlus.Net.Microservice.Locations.gRpc.Services;
...
builder.Services.AddMediatR<CodeDesignPlus.Net.Microservice.Locations.Application.Startup>();
builder.Services.AddFluentValidation();

builder.Services.AddMongo<CodeDesignPlus.Net.Microservice.Locations.Infrastructure.Startup>(builder.Configuration);
builder.Services.AddRedis(builder.Configuration);
builder.Services.AddRabbitMQ<CodeDesignPlus.Net.Microservice.Locations.Domain.Startup>(builder.Configuration);
builder.Services.AddServiceBus<CodeDesignPlus.Net.Microservice.Locations.Domain.Startup>(builder.Configuration);
