...
) : DomainEvent(aggregateId, eventId, occurredAt, metadata)
{
    ...
    public static CountryUpdatedDomainEvent Create(Guid aggregateId, string name, string alpha2, string alpha3, ushort code, string? capital, Guid idCurrency, string timeZone, bool isActive)
    {
        return new CountryUpdatedDomainEvent(aggregateId, name, alpha2, alpha3, code, capital, idCurrency, timeZone, isActive);
    }
}