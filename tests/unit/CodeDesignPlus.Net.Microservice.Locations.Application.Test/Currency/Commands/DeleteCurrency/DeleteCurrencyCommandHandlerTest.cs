...
namespace CodeDesignPlus.Net.Microservice.Locations.Application.Test.Currency.Commands.DeleteCurrency
{
    public class DeleteCurrencyCommandHandlerTest
    {
        ...
        public DeleteCurrencyCommandHandlerTest()
        {
            ...
            handler = new DeleteCurrencyCommandHandler(repositoryMock.Object, userContextMock.Object, pubSubMock.Object, countriesMock.Object, cacheMock.Object);
        }
        ...
        public async Task Handle_ValidRequest_DeletesCurrencyAndPublishesEvents()
        {
            ...
            pubSubMock.Verify(pubsub => pubsub.PublishAsync(It.IsAny<List<CurrencyDeletedDomainEvent>>(), cancellationToken), Times.AtMostOnce);
        }
    }
}
